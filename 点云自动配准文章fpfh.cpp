...
int main(int argc, char** argv) {
	...
	*features_source = *com_fpfh_feature(cloud_source, normals_source, key_source, 15.0 *leaf_size);//对比实验
	...
	*features_target = *com_fpfh_feature(cloud_target, normals_target, key_target, 15.0 *leaf_size);//对比实验
